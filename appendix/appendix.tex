...
Ziel des Workshops ist es, gemeinsam mit potenziellen Nutzer*innen konkrete Gestaltungsideen für ein In-Car-Onboarding eines Spurhalteassistenten zu entwickeln.

Die zuvor abgeleiteten Design Requirements bilden den wissenschaftlich begründeten Gestaltungsrahmen. Offene Spannungsfelder werden gezielt partizipativ bearbeitet. Als Ergebnis sollen priorisierte Gestaltungsideen bzw. Design Features entstehen, die anschließend zu einem Onboarding-Konzept weiterentwickelt werden.
...
\begin{itemize}
    \item \textbf{Dauer:} ca. 120 Minuten
    \item \textbf{Format:} Präsenzworkshop
    \item \textbf{Moderation:} durch den Verfasser der Masterarbeit
    \item \textbf{Dokumentation:} Audioaufnahme (falls Proband*innen zustimmen), Fotos der
...
Vielen Dank, dass ihr euch Zeit für den Workshop nehmt. Wir wollen heute gemeinsam Ideen dafür entwickeln, wie ein Spurhalteassistent im Fahrzeug so erklärt und begleitet werden könnte, dass Fahrer*innen ihn sicher und korrekt nutzen können. Dabei interessiert mich nicht, ob ihr euch technisch besonders gut mit Fahrassistenzsystemen auskennt. Entscheidend sind eure Erwartungen, Erfahrungen und Vorstellungen als Nutzer*innen. Es gibt keine richtigen oder falschen Antworten. Unterschiedliche Meinungen sind ausdrücklich erwünscht. Auch beim späteren Gestalten geht es nicht darum, besonders gut zeichnen zu können. Einfache Skizzen, Stichworte und Ideen reichen vollkommen aus.
...
Alle Teilnehmenden verfügen über ein gemeinsames Verständnis der Aufgabe und ihrer Rolle im Workshop.
...
\subsubsection*{Präsentation eines Videos}
An dieser Stelle wird ein Informationsvideo des ADAC präsentiert, welches sicherstellt, dass jede Person die grundsätzlichen Funktionsweisen eines Spurhalteassistenten und seine Grenzen kennt. Außerdem wird nach den eigenen Erfahrungen der Teilnehmer*innen mit einer Spurhalteassistenz gefragt.

\subsubsection*{Ausgangsszenario}

Stellt euch vor, eine Person steigt zum ersten Mal in ein neues Fahrzeug. Das Fahrzeug verfügt über einen Spurhalteassistenten, den sie bisher noch nicht benutzt hat. Sie weiß grundsätzlich, dass das System etwas mit dem Halten der Fahrspur zu tun hat, kennt aber weder die genaue Funktionsweise noch das Verhalten dieses konkreten Systems.
...
Jede Person erhält Post-its. Pro Post-it wird eine Idee notiert. Was müsstet ihr über diesen Spurhalteassistenten wissen oder verstehen, damit ihr euch bei der ersten Nutzung sicher fühlt und ihn korrekt verwenden könnt?

\subsubsection*{Schritt 2 - Gemeinsames Betrachten}
...
\begin{itemize}
    ...
    \item Ähnliche Aussagen werden gemeinsam anhand der Themenkarten gruppiert.
    \item Bei Bedarf können neue Themenkarten ergänzt werden.
    \item Die Moderation nimmt keine inhaltliche Bewertung vor.
\end{itemize}

\subsubsection*{Themenkarten als Clusterhilfe}
...
Relevante Inhalte fokussieren und gleichzeitig sichtbar
machen, welche Inhalte erst später oder optional vertieft werden können.


\subsubsection*{Schritt 1 - Individuelle Priorisierung}

\noindent
\textbf{Dauer:} ca. 5 Minuten

Jede Person erhält fünf Klebepunkte und kann diese auf die Post-its oder Themenkarten verteilen. Welche Inhalte sind für ein sicheres Verständnis besonders wichtig?


\subsubsection*{Schritt 2 - Gemeinsame Einordnung}

\noindent
\textbf{Dauer:} ca. 5 Minuten

Die Post-its oder Themenkarten werden in eine Matrix mit drei Spalten einsortiert.

\begin{itemize}
    \item \textbf{A:} Hat die höchste Priorität
...
Eine Priorisierung der Onboarding-Inhalte.
...
Bestimmen, zu welchem Zeitpunkt wichtige Informationen vermittelt werden sollten und ob sich die gewünschte Informationstiefe je nach Zeitpunkt unterscheidet.
...
Ordnet die wichtigsten Ordnet die wichtigsten Inhaltskarten und/oder eure eigenen Ergänzungen einem oder mehreren Zeitpunkten zu. Wenn eine Information mehrfach vorkommen soll, überlegt zusätzlich, ob sie jedes Mal gleich ausführlich vermittelt werden muss.
...
Eine Zuordnung der priorisierten Inhalte zu den Informationszeitpunkten.
...
\subsection{Von Choose zu Create - Gestaltungsrahmen mit Design Requirements und Spannungsfeldern}
...
Die Design Requirements werden in sechs Karten für den
Gestaltungsrahmen gebündelt. Die Teilnehmenden sollen die Design Requirements nicht grundsätzlich neu bewerten. Die Karten dienen als Gestaltungsrahmen für die nachfolgende Ideengenerierung. Gleichzeitig bleiben die aus der Synthese abgeleiteten Spannungsfelder als offene Gestaltungsfragen bewusst bestehen.
...
Ein gemeinsames Verständnis des Gestaltungsrahmens bei weiterhin offenem Lösungsraum.
...
Situation, beispielsweise schlechter oder uneindeutiger Fahrbahnmarkierungen, kann der Spurhalteassistent nicht mehr zuverlässig unterstützen.

\paragraph*{Unterstützende Fragen}
...
\begin{itemize}
    ...
    \item \textbf{Runde 1 (ca. 13 Minuten):}
    Gruppe A bearbeitet Szenario A, Gruppe B Szenario B.

    \item \textbf{Runde 2 (ca. 13 Minuten):}
    Gruppe A bearbeitet Szenario B, Gruppe B Szenario A.

    \item \textbf{Kurzvorstellung (ca. 9 Minuten):}
...
Paper Prototypes beziehungsweise kleinere Storyboards mit konkreten
Gestaltungselementen, die als potenzielle Design Features für das spätere Onboarding-Konzept dienen.
...
\noindent
\textbf{Dauer:} ca. 2 Minuten

Jede Person erhält fünf Klebepunkte. Markiert konkrete Gestaltungselemente, die aus eurer Sicht unbedingt in das spätere Onboarding einfließen sollten. Bewertet werden einzelne Features, nicht ein vollständiger Entwurf als Gewinner oder Verlierer.
...
\clearpage
% ============================================================
% Abbildungen partizipativer Workshop eins
% ============================================================

\section{Gestaltungslösungen des ersten Workshops}
\label{sec:gestaltungslösungen_w1}

\subsection{Gruppe 1, Szenario A}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/results/Workshop_1/SA_G1(1).png}
    \caption{Gestaltungslösung Gruppe 1 Szenario A (1/3)}
    \label{fig:W1_SA_G1_1}
    \medskip
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/results/Workshop_1/SA_G1(2).png}
    \caption{Gestaltungslösung Gruppe 1 Szenario A (2/3)}
    \label{fig:W1_SA_G1_2}
    \medskip
    {\footnotesize Quelle: Eigene Fotografie.}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/results/Workshop_1/SA_G1(3).png}
    \caption{Gestaltungslösung Gruppe 1 Szenario A (3/3)}
    \label{fig:W1_SA_G1_3}
    \medskip
    {\footnotesize Quelle: Eigene Fotografie.}
\end{figure}

\subsection{Gruppe 2, Szenario A}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/results/Workshop_1/SA_G2(1).png}
    \caption{Gestaltungslösung Gruppe 2 Szenario A (1/3)}
    \label{fig:W1_SA_G2_1}
    \medskip
    {\footnotesize Quelle: Eigene Fotografie.}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/results/Workshop_1/SA_G2(2).png}
    \caption{Gestaltungslösung Gruppe 2 Szenario A (2/3)}
    \label{fig:W1_SA_G2_2}
    \medskip
    {\footnotesize Quelle: Eigene Fotografie.}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/results/Workshop_1/SA_G2(3).png}
    \caption{Gestaltungslösung Gruppe 2 Szenario A (3/3)}
    \label{fig:W1_SA_G2_3}
    \medskip
    {\footnotesize Quelle: Eigene Fotografie.}
\end{figure}

\subsection{Gruppe 1, Szenario B}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/results/Workshop_1/SB_G1.png}
    \caption{Gestaltungslösung Gruppe 1 Szenario B}
    \label{fig:W1_SB_G1}
    \medskip
    {\footnotesize Quelle: Eigene Fotografie.}
\end{figure}

\subsection{Gruppe 2, Szenario B}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/results/Workshop_1/SB_G2(1).png}
    \caption{Gestaltungslösung Gruppe 2 Szenario B (1/2)}
    \label{fig:W1_SB_G2_1}
    \medskip
    {\footnotesize Quelle: Eigene Fotografie.}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/results/Workshop_1/SB_G2(2).png}
    \caption{Gestaltungslösung Gruppe 2 Szenario B (2/2)}
    \label{fig:W1_SB_G2_2}
    \medskip
    {\footnotesize Quelle: Eigene Fotografie.}
\end{figure}
...
\clearpage
% ============================================================
% Abbildungen partizipativer Workshop zwei
% ============================================================

\section{Gestaltungslösungen des zweiten Workshops}
\label{sec:gestaltungslösungen_w2}

\subsection{Gruppe 1, Szenario A}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/results/Workshop_2/SA_G1(1).png}
    \caption{Gestaltungslösung Gruppe 1 Szenario A (1/2)}
    \label{fig:W2_SA_G1_1}
    \medskip
    {\footnotesize Quelle: Eigene Fotografie.}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/results/Workshop_2/SA_G1(2).png}
    \caption{Gestaltungslösung Gruppe 1 Szenario A (2/2)}
    \label{fig:W2_SA_G1_2}
    \medskip
    {\footnotesize Quelle: Eigene Fotografie.}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/results/Workshop_2/SA_G2(1).png}
    \caption{Gestaltungslösung Gruppe 2 Szenario A (1/2)}
    \label{fig:W2_SA_G2_1}
    \medskip
    {\footnotesize Quelle: Eigene Fotografie.}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/results/Workshop_2/SA_G2(2).png}
    \caption{Gestaltungslösung Gruppe 2 Szenario A (2/2)}
    \label{fig:W2_SA_G2_2}
    \medskip
    {\footnotesize Quelle: Eigene Fotografie.}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/results/Workshop_2/SB_G1(1).png}
    \caption{Gestaltungslösung Gruppe 1 Szenario B (1/3)}
    \label{fig:W2_SB_G1_1}
    \medskip
    {\footnotesize Quelle: Eigene Fotografie.}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/results/Workshop_2/SB_G1(2).png}
    \caption{Gestaltungslösung Gruppe 1 Szenario B (2/3)}
    \label{fig:W2_SB_G1_2}
    \medskip
    {\footnotesize Quelle: Eigene Fotografie.}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/results/Workshop_2/SB_G1(3).png}
    \caption{Gestaltungslösung Gruppe 1 Szenario B (3/3)}
    \label{fig:W2_SB_G1_3}
    \medskip
    {\footnotesize Quelle: Eigene Fotografie.}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/results/Workshop_2/SB_G2(1).png}
    \caption{Gestaltungslösung Gruppe 2 Szenario B (1/2)}
    \label{fig:W2_SB_G2_1}
    \medskip
    {\footnotesize Quelle: Eigene Fotografie.}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/results/Workshop_2/SB_G2(2).png}
    \caption{Gestaltungslösung Gruppe 2 Szenario B (2/2)}
    \label{fig:W2_SB_G2_2}
    \medskip
    {\footnotesize Quelle: Eigene Fotografie.}
\end{figure}