...
Der Leitfaden umfasste zunächst Fragen zur bisherigen Erfahrung mit Fahrassistenzsystemen und zum jeweiligen Nutzungskontext. Anschließend wurden die erste Nutzung entsprechender Systeme, bisherige Formen der Informationsvermittlung und die persönliche Aneignung der Funktionsweise
thematisiert. Weitere Fragen bezogen sich auf das Verständnis der Systemfunktion und -grenzen sowie auf Erwartungen und Präferenzen hinsichtlich eines möglichen In-Car-Onboardings.
...
Die Interviews wurden mit Einverständnis der Teilnehmenden aufgezeichnet und anschließend für die qualitative Auswertung transkribiert. Personenbezogene Angaben wurden im Rahmen der Aufbereitung anonymisiert. 

\subsubsection{Qualitative Inhaltsanalyse}
