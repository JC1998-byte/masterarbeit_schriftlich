...
wurde im Rahmen dieser DSR-Aktivität ein
partizipativer Workshop durchgeführt. Ziel des Workshops war es, die
wissenschaftlich und empirisch begründeten Anforderungen gemeinsam mit
potenziellen Nutzer*innen in konkrete Gestaltungsideen für ein
In-Car-Onboarding zu überführen. Dabei sollten insbesondere solche
Gestaltungsentscheidungen partizipativ konkretisiert werden, deren Ausprägung
auf Grundlage von Literatur und Interviews noch nicht eindeutig festgelegt
werden konnte.

Die Design Requirements bildeten damit den inhaltlichen Gestaltungsrahmen des
Workshops, während die zuvor identifizierten Spannungsfelder als offene
Gestaltungsfragen in den Workshop eingebracht wurden. Die Teilnehmenden sollten
...
\subsection{Partizipativer Workshop}
...
Der vollständige Workshop umfasste eine Dauer von etwa
105 Minuten und wurde als Präsenzworkshop durchgeführt. Der detaillierte
...
auf Haftnotizen die Frage, welche Informationen oder welches Verständnis sie
...
stattfand. Anschließend wurden die Beiträge für alle sichtbar zusammengeführt,
inhaltlich ähnliche Aussagen gemeinsam gruppiert und kurz diskutiert. Die
Moderation nahm hierbei keine inhaltliche Bewertung der Beiträge vor.
...
Informationsbedarfe fokussiert und priorisiert. Hierzu wurden neun
Informationsbereiche verwendet, die sich aus den zuvor durchgeführten
Interviews, dem Forschungsstand sowie den daraus abgeleiteten Design
Requirements ergaben. Die Bereiche umfassten den Zweck der Assistenzfunktion,
deren Bedienung, Systemstatus, Funktionsweise und Eingriffe,
Einsatzbedingungen, Systemgrenzen, die Rolle der fahrzeugführenden Person,
Anzeigen und Warnungen sowie das Verhalten bei Systemgrenzen.

Die während der Collect-Phase entstandenen Beiträge wurden diesen
Informationsbereichen zugeordnet. Beiträge, die keinem bestehenden Bereich
zugeordnet werden konnten, konnten als zusätzliche Kategorie ergänzt werden.
Anschließend priorisierten die Teilnehmenden die Inhalte zunächst individuell
mittels Klebepunkten. Darauf aufbauend wurden die Informationsbereiche
gemeinsam danach eingeordnet, ob sie bereits beim Einstieg vermittelt werden
müssen, für den Einstieg hilfreich sind oder erst später beziehungsweise bei
...
\subsubsection{Überführung der Design Requirements in den Gestaltungsrahmen}
...
Teilnehmenden in zwei Kleingruppen mit Paper Prototyping und Storyboards.
...
entwickelten den bereits entstandenen Entwurf der jeweils anderen Gruppe
weiter. Dadurch konnten unterschiedliche Perspektiven auf denselben Entwurf
einfließen, ohne dass unmittelbar eine endgültige Lösung festgelegt wurde.
Die entstandenen Paper Prototypes und Storyboards dienten als Grundlage für
die anschließende Bewertung.

\subsubsection{Commit: Bewertung und Verdichtung}

In der abschließenden Commit-Phase wurden die während des Workshops
...
Gestaltungsfragen gemeinsam diskutiert. Die Moderation dokumentierte sowohl
mehrheitlich unterstützte Gestaltungselemente als auch abweichende Positionen.

Die auf diese Weise priorisierten Gestaltungselemente bildeten gemeinsam mit
den Design Requirements die Grundlage für die anschließende Konsolidierung zu
einem zusammenhängenden Onboarding-Konzept. Dabei konnten die entwickelten
Design Features jeweils auf die zugrunde liegenden Design Requirements sowie
auf ihre Entstehung im Workshop zurückgeführt werden.
