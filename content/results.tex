...
Nachfolgend wurde eine Matrix (siehe Tabelle \ref{tab:analysematrix_workshops}) angefertigt, um die Entwürfe der verschiedenen Gruppen innerhalb der Workshops systematisch auszuwerten. In der ersten Spalte ist in Klammern die zuvor erwähnte Originaldarstellung im Anhang aufgeführt, auf welche sich die Analyse bezieht. Mögliche Gegenpositionen innerhalb und zwischen den Workshops werden transparent dargestellt.
...
\toprule
\textbf{ID} &
\textbf{Gestaltungselement} &
\textbf{Konkrete Ausprägung} &
\textbf{Zweck / Funktion} &
\textbf{Modalität / Ort} &
\textbf{Klebepunkte} &
\textbf{Gegenposition / Kritik}
\\
\midrule
\endfirsthead
...
\rowcolor{black!6}
\multicolumn{7}{l}{%
    \textbf{Workshop 1 -- Gruppe 1, Szenario A}%
}
\\
\rowrule
1 (\ref{fig:W1_SA_G1_1}) &
Videobasiertes Onboarding mit visuellen Symbolen &
Video vor Fahrtantritt auf dem zentralen Display; zusätzlich werden Symbole sowie eine Farbcodierung in Rot, Gelb und Grün vorgesehen &
Die Assistenzfunktion vor der ersten Nutzung erklären und Informationen visuell unterscheidbar darstellen &
Audiovisuell und visuell; Center Display &
4 &
--
\\
\rowrule
2 (\ref{fig:W1_SA_G1_2}) &
Alternative Anzeige im Kombiinstrument &
Das Kombiinstrument wird als Alternative zum großen zentralen Display vorgeschlagen &
Onboarding-Informationen alternativ zum Center Display darstellen &
Visuell; Kombiinstrument &
0 &
In einem anderen Entwurf wird das Kombiinstrument als unübersichtlich kritisiert
\\
\rowrule
3 (\ref{fig:W1_SA_G1_3}) &
Ablehnung einer HUD-Darstellung &
Auf der Windschutzscheiben-Vorlage wird ausdrücklich „Nein!“ notiert &
Ausdrücken, dass eine Informationsdarstellung über die Windschutzscheibe bzw. ein HUD nicht gewünscht ist &
HUD / Windschutzscheibe &
1 &
Andere Teilnehmende bewerten eine konkrete HUD-Warnung positiv; die Ablehnung wurde im Workshop insbesondere mit fehlender Vertrautheit mit HUDs begründet
\\
\rowrule
\rowcolor{black!6}
\multicolumn{7}{l}{%
    \textbf{Workshop 1 -- Gruppe 2, Szenario A}%
}
\\
\rowrule
4 (\ref{fig:W1_SA_G2_1}) &
Kurzes Onboarding-Video &
Einführung in Form eines Kurzvideos &
Die Assistenzfunktion kompakt und geführt vorstellen &
Audiovisuell; Center Display &
3 &
--
\\
\rowrule
5 (\ref{fig:W1_SA_G2_2}) &
Kennenlernen in geeigneter Onboarding-Situation &
Assistenzfunktion über Mediasystem im Center Display kennenlernen - kein HUD verwenden &
Das erstmalige Kennenlernen in einem dafür geeigneten Nutzungskontext ermöglichen &
Center Display &
0 &
--
\\
\rowrule
6 (\ref{fig:W1_SA_G2_3}) &
Trennung vom aktiven Fahrdisplay &
Das Kombiinstrument wird als „unübersichtlich“ bezeichnet und soll von aktiven Fahrsignalen getrennt bleiben &
Zusätzliche Informationskonkurrenz mit fahrrelevanten Anzeigen vermeiden &
Visuell; Kombiinstrument &
0 &
Ein anderer Entwurf schlägt das Kombiinstrument ausdrücklich als alternative Darstellungsfläche vor
\\
\rowrule
\rowcolor{black!6}
\multicolumn{7}{l}{%
    \textbf{Workshop 1 -- Gruppe 1, Szenario B}%
}
\\
\rowrule
7 (\ref{fig:W1_SB_G1}) &
Automatisches Ausschalten mit multimodaler Statusrückmeldung &
Der Assistent schaltet sich automatisch aus; eine visuelle Anzeige und ein Ton informieren darüber, dass er inaktiv ist &
Auf die Systemgrenze reagieren und den veränderten Systemstatus eindeutig kommunizieren &
Systemverhalten; visuell und akustisch im Kombiinstrument &
2 &
Ein anderer Entwurf fordert stattdessen eine Deaktivierung des Systems durch die fahrzeugführende Person
\\
\rowrule
\rowcolor{black!6}
\multicolumn{7}{l}{%
    \textbf{Workshop 1 -- Gruppe 2, Szenario B}%
}
\\
\rowrule
8 (\ref{fig:W1_SB_G2_1}) &
Warnung im HUD &
Der Hinweis „Spurassistent aus!“ wird auf die Windschutzscheibe projiziert &
Die Nichtverfügbarkeit des Assistenten unmittelbar und blicknah anzeigen &
Visuell; HUD / Windschutzscheibe &
5 &
Eine andere Person lehnt eine HUD-Darstellung grundsätzlich ab
\\
\rowrule
9 (\ref{fig:W1_SB_G2_2}) &
Status- bzw. Warnicon &
Ein Icon wird als alternative Darstellung des veränderten Systemzustands vorgeschlagen &
Die Statusänderung mit einem kompakten visuellen Signal vermitteln &
Visuell; Kombiinstrument &
1 &
Alternative zur projizierten HUD-Warnung
\\
\rowrule
\rowcolor{black!6}
\multicolumn{7}{l}{%
    \textbf{Workshop 2 -- Gruppe 1, Szenario A}%
}
\\
\rowrule
10 (\ref{fig:W2_SA_G1_1}) &
Zugang über die Fahrzeugeinstellungen &
Ein Bereich „Assistenzsysteme“ ist über einen entsprechenden Button innerhalb der Einstellungen erreichbar &
Informationen zu Assistenzsystemen gezielt auffindbar machen &
Interaktiv; Center Display &
0 &
--
\\
\rowrule
11 (\ref{fig:W2_SA_G1_2}) &
Verbindliche schrittweise Einführung &
Kurze Einführung, bei der jeder Schritt bestätigt werden muss, bevor die Zündung eingeschaltet werden kann &
Sicherstellen, dass die Einführung vor der Nutzung durchlaufen wird &
Interaktiv; Center Display &
1 &
--
\\
\rowrule
12 (\ref{fig:W2_SA_G1_2}) &
Möglichkeit zur Fragestellung &
Innerhalb der Einführung besteht die Möglichkeit, Fragen zu stellen &
Individuelle Unklarheiten während des Onboardings adressieren &
Interaktiv; Center Display &
1 &
--
\\
\rowrule
13 (\ref{fig:W2_SA_G1_2}) &
Informationen zur Deaktivierung &
Das Onboarding erläutert Möglichkeiten, den Assistenten auszuschalten &
Die Bedienung und insbesondere die Deaktivierung der Assistenzfunktion vermitteln &
Visuell / interaktiv; Center Display &
1 &
--
\\
\rowrule
\rowcolor{black!6}
\multicolumn{7}{l}{%
    \textbf{Workshop 2 -- Gruppe 2, Szenario A}%
}
\\
\rowrule
14 (\ref{fig:W2_SA_G2_1}) &
Verpflichtendes Video-Tutorial &
Vor der ersten Fahrt muss ein Video verpflichtend angesehen werden; erst anschließend kann das Fahrzeug gestartet werden &
Eine verpflichtende Einführung vor der ersten Fahrt sicherstellen &
Audiovisuell; Center Display &
2 &
--
\\
\rowrule
15 (\ref{fig:W2_SA_G2_1}) &
Späteres Überspringen des Tutorials &
Nach dem erstmaligen Absolvieren kann das Video-Tutorial künftig über das Menü des Spurhalteassistenten übersprungen werden &
Eine erneute verpflichtende Wiedergabe bei späterer Nutzung vermeiden &
Interaktiv; Center Display &
0 &
--
\\
\rowrule
16 (\ref{fig:W2_SA_G2_2}) &
Statushinweis im Kombiinstrument &
Hinweis „Spurhalteassistent aktiv! Infos auf dem Screen beachten“ &
Den Aktivitätsstatus des Assistenten anzeigen und auf weiterführende Informationen hinweisen &
Visuell; Kombiinstrument &
0 &
--
\\
...
\rowcolor{black!6}
\multicolumn{7}{l}{%
    \textbf{Workshop 2 -- Gruppe 1, Szenario B}%
}
\\
\rowrule
17 (\ref{fig:W2_SB_G1_1}) &
Warnmeldung bei ausgeschaltetem Assistenten &
Textmeldung „Achtung! Assistent ist ausgeschaltet!“ &
Einen vollständig inaktiven Systemzustand eindeutig kommunizieren &
Visuell; Center Display &
1 &
Im selben Entwurf wird als zweite Variante eine eingeschränkte Verfügbarkeit kommuniziert
\\
\rowrule
18 (\ref{fig:W2_SB_G1_1}) &
Warnmeldung bei eingeschränktem Assistenten &
Textmeldung „Achtung! Assistent eingeschränkt!“ &
Eine eingeschränkte Systemverfügbarkeit kommunizieren &
Visuell; Center Display &
1 &
Alternative zur Meldung eines vollständig ausgeschalteten Assistenten
\\
\rowrule
19 (\ref{fig:W2_SB_G1_2}) &
Warnsymbol im Kombiinstrument &
Ein visuelles Warnsymbol wird im Kombiinstrument dargestellt &
Die kritische Zustandsänderung kompakt sichtbar machen &
Visuell; Kombiinstrument &
0 &
--
\\
\rowrule
20 (\ref{fig:W2_SB_G1_2}) &
Textuelle Statusmeldung im Kombiinstrument &
Eine Meldung informiert darüber, dass sich der Assistent ausschaltet &
Die Statusänderung zusätzlich sprachlich erklären &
Visuell; Kombiinstrument &
0 &
--
\\
\rowrule
21 (\ref{fig:W2_SB_G1_3}) &
Situationsbezogene Erklärung mit Reflexionsfrage &
Hinweis „Achtung! Spurhalteassistent kann nicht unterstützen. Woran kann das liegen?“ &
Auf die Systemgrenze hinweisen und zur Auseinandersetzung mit deren möglicher Ursache anregen &
Visuell; Kombiinstrument &
0 &
--
\\
...
\rowcolor{black!6}
\multicolumn{7}{l}{%
    \textbf{Workshop 2 -- Gruppe 2, Szenario B}%
}
\\
\rowrule
22 (\ref{fig:W2_SB_G2_1}) &
Warnung mit Erklärung und Handlungsempfehlung &
Der Hinweis warnt davor, dass der Spurhalteassistent nicht oder falsch reagieren kann, und fordert zur Deaktivierung des Systems auf &
Das mögliche Fehlverhalten erklären und gleichzeitig eine konkrete Handlungsoption vermitteln &
Visuell; Center Display &
0 &
Ein anderer Entwurf sieht ein automatisches Ausschalten des Assistenten vor
\\
\rowrule
23 (\ref{fig:W2_SB_G2_2}) &
Dringliche Gefahrenwarnung &
Warnsymbol mit dem Hinweis „Gefahr! Spurhalteassistent“ sowie der Aufforderung, die Displayinformation zu beachten &
Eine kritische Systemgrenze mit einer auffälligen und kompakten Warnung kommunizieren &
Visuell; Kombiinstrument &
5 &
\--
\\*
...
\caption{Analysematrix der Gestaltungselemente aus den Entwürfen der partizipativen Workshops}
\label{tab:analysematrix_workshops}
\\

\end{xltabular}
}

Tabelle \ref{tab:verbalisierte_praeferenzen_workshops} ergänzt zusätzlich Gesprächsinhalte bzgl. der offenen Fragen aus dem Leitfaden, welche nicht durch das Fotoprotokoll abgedeckt werden. Die Gesprächsinhalte wurden von der Moderation während der Workshops verschriftlicht, da in keinem Workshop alle Teilnehmer*innen Bild- oder Tonaufnahmen zugestimmt haben.
...
1 &
Collect &
Die Erfahrungen mit Spurhalteassistenten werden von allen Teilnehmenden als größtenteils negativ beschrieben. Thematisiert werden insbesondere unklare Reaktionen des Assistenten sowie Überforderung. &
Gemeinsamer Problemhintergrund
\\
...
1 &
Collect &
Aufgrund der negativen Vorerfahrungen besteht bei den meisten Teilnehmenden der Wunsch zu erfahren, wie der Spurhalteassistent deaktiviert werden kann. &
Mehrheitsposition
\\
...
1 &
Collect &
Die Teilnehmenden sind sich einig, dass Missverständnisse hinsichtlich des Aktivitätsstatus des Spurhalteassistenten besonders problematisch sind. &
Konsens
\\
...
1 &
Commit &
Videos im Display der Mittelkonsole werden als geeignete Vermittlungsform für ein Onboarding vor Fahrtantritt betrachtet und sollen aus Sicht der Teilnehmenden übernommen werden. &
Konsens
\\
...
1 &
Commit &
Die Nutzung eines Head-Up-Displays für ein Onboarding vor Fahrtantritt wird von beiden Gruppen abgelehnt. &
Konsens
\\
...
1 &
Commit &
Eine Gruppe befürwortet die Nutzung eines Head-Up-Displays für kontextspezifische Hinweise während der Fahrt, um Blickabwendungen von der Straße zu reduzieren. Die andere Gruppe äußert Vorbehalte, da keine Erfahrungen mit dieser Technologie bestehen. &
Dissens
\\
...
1 &
Commit &
Eine Gruppe präferiert für kontextspezifische Hinweise das Kombiinstrument. Die andere Gruppe lehnt diese Lösung deutlich ab, da entsprechende Hinweise getrennt von den dort bereits vorhandenen Signalen dargestellt werden müssten. &
Dissens
\\
...
1 &
Commit &
Für die Gestaltung kontextspezifischer Hinweise besteht insgesamt keine klare Einigung zwischen den beiden Gruppen. &
...
2 &
Collect &
Die Erfahrungen mit Spurhalteassistenten werden ebenfalls als größtenteils negativ beschrieben, insbesondere in Baustellensituationen. Zusätzlich berichten die Teilnehmenden, von entsprechenden Problemen bereits aus den Medien gehört zu haben. &
Gemeinsamer Problemhintergrund
\\
...
2 &
Collect &
Den meisten Teilnehmenden ist besonders wichtig zu verstehen, wie der Spurhalteassistent funktioniert und wie er in die Fahrzeugführung eingreift. In diesem Zusammenhang werden Missverständnisse als besonders problematisch angesehen. &
Mehrheitsposition
\\
...
2 &
Commit &
Videos im Display der Mittelkonsole werden auch in diesem Workshop als geeignete Vermittlungsform für ein Onboarding vor Fahrtantritt betrachtet. Alternativ werden klassische Screens ebenfalls als geeignet angesehen. &
Konsens
\\
...
2 &
Commit &
Beide Gruppen bevorzugen grundsätzlich eine einfache und konsistente Gestaltung und möchten ausgefallene sowie komplexe Darstellungen vermeiden. &
Konsens
\\
...
2 &
Commit &
Für kontextspezifische Informationen bevorzugen beide Gruppen das Kombiinstrument. Das Display in der Mittelkonsole wird als ergänzende Darstellungsfläche betrachtet. &
Konsens
\\
...
2 &
Commit &
Zwischen den beiden Gruppen besteht kein erkennbarer Dissens. &
Kein erkennbarer Dissens
\\*

\bottomrule

\caption{Verschriftliche Gesprächsinhalte der partizipativen Workshops}
\label{tab:verbalisierte_praeferenzen_workshops}
\\
...
Tabelle \ref{tab:design_features} zeigt die aus den Workshops und den Design Requirements abgeleiteten Design Features.
...
\hline
\textbf{ID} &
\textbf{Design Feature} &
\textbf{Konkrete Umsetzung} &
\textbf{Bezug zu Design Requirements} &
\textbf{Grundlage aus den Workshops}
\\
\hline
\endfirsthead
...
\textbf{Design Feature} &
\textbf{Konkrete Umsetzung} &
\textbf{Bezug zu Design Requirements (siehe \ref{tab:design-requirements})} &
\textbf{Grundlage aus den Workshops (siehe \ref{tab:analysematrix_workshops})}
\\
\hline
\endhead
...
DF-01 &
Geführte multimediale Einführung im Center Display &
Vor der ersten Fahrt wird eine kurze, geführte Einführung über das Center Display bereitgestellt. Zentrales Vermittlungsmedium ist ein kurzes Video, das durch einfache visuelle Screens beziehungsweise Symbole ergänzt werden kann. &
DR-01, DR-07, DR-10, DR-12 &
Gestaltungselemente 1, 4 und 14. Videos im Center Display wurden zudem in der gemeinsamen Reflexion beider Workshops ausdrücklich als geeignete Vermittlungsform für das Onboarding vor Fahrtantritt hervorgehoben.
\\
\hline

DF-02 &
Verbindlicher Erst-Durchlauf des Sicherheitskerns &
Bei der erstmaligen Nutzung werden zentrale sicherheitsrelevante Einführungsschritte nacheinander durchlaufen. Der verbindliche Informationskern muss abgeschlossen werden, bevor das Onboarding beendet beziehungsweise die Assistenzfunktion regulär genutzt wird. &
DR-07, DR-12 &
Gestaltungselemente 11 und 14 konkretisieren einen verbindlichen Erst-Durchlauf. Gestaltungselement 15 sieht zugleich vor, dass das Tutorial nach dem erstmaligen Absolvieren bei späterer Nutzung übersprungen werden kann.
\\
\hline

DF-03 &
Wiederaufrufbarer Informationsbereich &
Im Menü der Assistenzsysteme bleibt das Onboarding dauerhaft erreichbar. Bereits vermittelte Inhalte können erneut aufgerufen und weiterführende Informationen bei Bedarf vertieft werden. &
DR-11, DR-12 &
Gestaltungselemente 10, 12 und 15 sehen einen erneuten Zugriff auf bereits vermittelte Inhalte sowie bedarfsgerechte Vertiefungsmöglichkeiten vor.
\\
\hline

DF-04 &
Eindeutige Systemstatusanzeige &
Der Status des Spurhalteassistenten wird durch konsistente visuelle Symbole und kurze Textinformationen eindeutig als aktiv, eingeschränkt beziehungsweise inaktiv dargestellt. &
DR-02, DR-09, DR-10 &
Gestaltungselemente 9 und 16-20 greifen unterschiedliche Formen der Statuskommunikation auf. Im ersten Workshop wurde zudem ausdrücklich hervorgehoben, dass Missverständnisse hinsichtlich des Aktivitätsstatus besonders problematisch sind.
\\
\hline

DF-05 &
Situationsbezogene Grenzwarnung mit abgestufter Dringlichkeit &
Wird eine relevante Systemgrenze erreicht, erscheint unmittelbar eine kurze situationsbezogene Warnung mit Symbol und Statusinformation. Bei höherer Kritikalität kann die visuelle Warnung durch ein akustisches Signal beziehungsweise eine deutlich hervorgehobene Warnstufe ergänzt werden. &
DR-04, DR-07, DR-08, DR-09, DR-10 &
Gestaltungselemente 7-9 und 17-23 enthalten unterschiedliche Varianten situationsbezogener Warnungen. Die Gestaltungselemente 8 und 23 erhielten jeweils fünf Klebepunkte. Hinsichtlich des konkreten Darstellungsortes zeigten sich zwischen den Workshops unterschiedliche Präferenzen.
\\
\hline

DF-06 &
Handlungsorientierte Information bei Systemgrenzen &
Eine situationsbezogene Warnung informiert nicht nur über den aktuellen Systemzustand, sondern benennt kurz die erforderliche Reaktion der fahrenden Person, beispielsweise die Übernahme der Fahrzeugführung oder die Deaktivierung des Assistenten. Weiterführende Erklärungen können ergänzend über das Center Display bereitgestellt werden. &
DR-04, DR-05, DR-08 &
Gestaltungselemente 13, 21 und 22 greifen die Deaktivierung, die Erklärung einer Systemgrenze und konkrete Handlungsoptionen auf. Im ersten Workshop wurde zusätzlich ein deutlicher Informationsbedarf hinsichtlich der Deaktivierung des Spurhalteassistenten geäußert.
\\
\hline

\caption{Aus den Design Requirements und den Ergebnissen der partizipativen Workshops abgeleitete Design Features}
\label{tab:design_features}
\\

\end{xltabular}
}

Es wird an dieser Stelle deutlich, dass nicht zu allen zuvor festgelegten Design Requirements (siehe \ref{tab:design-requirements}) ein Bezug in der Tabelle besteht. Die Design Requirement 03, 06, 13 und 14 könnten nur dann zugeordnet werden, wenn die konkrete Umsetzung im Workshopmaterial nachvollziehbar belegt werden kann. Gleichwohl erscheint es zielführend, diese zumindest implizit für die Gestaltung des Simulatorszenarios zu berücksichtigen. 

Für die Design Features ist zu beachten, dass von den Proband*innen in den partizipativen Workshops aus zeitlichen Gründen nicht verlangt werden konnte, zwei verschiedene Szenarien so detailliert auszuarbeiten, dass diese sich einerseits mit den Limitationen einer Simulationsumgebung im Einklang befinden und andererseits so umfangreich sind, dass es sich um nahezu perfekte Blaupausen für die konkrete Umsetzung handelt. Stattdessen sollten diese bestmöglich und unter Achtung der Erkenntnisse aus der Literatur sowie vorhandenem Expertenwissen umgesetzt werden.  
