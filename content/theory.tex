...
Für ein Onboarding lässt sich ableiten, dass ein multimodaler Ansatz, der räumliche Nähe vermittelt, sich als vielversprechend erweist. Ein Onboarding sollte mehr leisten, als nur Funktionen zu erklären, indem konkrete Nutzungssituationen praxisnah und unter Einbezug aller sinnvollen Informationskanäle beschrieben werden. Dabei sollte das Vertrauen in die Assistenzsysteme nicht einfach maximiert, sondern kalibriert werden.
...
Als bisher noch nicht genannter Aspekt, folgt für ein Onboarding, dass Informationen auf lernrelevante Inhalte begrenzt werden sollten und eine deutliche Priorisierung der Inhalte vorgenommen werden sollte.
